...
解密后文件位于 `~/Repo/wechat-to-LLM/wechat-decrypt/decrypted/`：
...
cp ~/Repo/wechat-to-LLM/backup/all_keys.json ~/Repo/wechat-to-LLM/wechat-decrypt/all_keys.json

cd ~/Repo/wechat-to-LLM/wechat-decrypt
...
pattern = os.path.expanduser('~/Repo/wechat-to-LLM/wechat-decrypt/decrypted/message/message_*.db')
